 ...
 *
 * `POST /v1/kt/{code}/ask`: the same grounding gate as Ask JUTSU, over the package
 * subject's own documents inside the package window (ADR 0025), with the conversation so
 * far as context — and every conversation is stored, so a recipient can leave and pick it
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-2 max-w-prose text-pretty text-sm leading-relaxed text-muted-foreground">
          ...
          The copilot answers from their own documents inside this package&apos;s window,
          with the conversation so far as context, and keeps every conversation so you can
          pick it up later.
        </p>
      </div>
